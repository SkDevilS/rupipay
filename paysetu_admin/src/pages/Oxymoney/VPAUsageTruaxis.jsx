...
const VPAUsageTruaxis = () => {
  ...
  const fetchVPAUsage = async () => {
    try {
      setRefreshing(true);
      const response = await adminAPI.getOxymoneyTruaxisVPAUsage();
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Oxymoney_Truaxis VPA Usage Monitor</h1>
...
export default VPAUsageTruaxis;
