...
from airpay_truaxis_callback_routes import airpay_truaxis_callback_bp
from airpay_grosmart2_callback_routes import airpay_grosmart2_callback_bp
from airpay_coco_callback_routes import airpay_coco_callback_bp
...
from paytouch4_callback_routes import paytouch4_callback_bp
from paytouch5_coco_callback_routes import paytouch5_coco_callback_bp
from paytouch6_veltrix_callback_routes import paytouch6_veltrix_callback_bp
from paystorepe_veltrix_callback_routes import paystorepe_veltrix_callback_bp
from paystorepe_coco_callback_routes import paystorepe_coco_callback_bp
from bridgmoney_coco_callback_routes import bridgmoney_coco_callback_bp
from bridgmoney_coco_beneficiary_routes import bridgmoney_coco_beneficiary_bp
...
from oxymoney_truaxis_routes import oxymoney_truaxis_bp
from oxymoney_truaxis_callback_routes import oxymoney_truaxis_callback_bp
from oxymoney_barringer_routes import oxymoney_barringer_bp
from oxymoney_barringer_callback_routes import oxymoney_barringer_callback_bp
...
from rmscoco_callback_routes import rmscoco_callback_bp
from hdfcpaytouch_barringer_callback_routes import hdfcpaytouch_barringer_callback_bp
from upilnk_coco_callback_routes import upilnk_coco_callback_bp
from toucanpay_veltrix_callback_routes import toucanpay_veltrix_callback_bp
...
from bulk_bank_routes import bulk_bank_bp
...
app.register_blueprint(airpay_truaxis_callback_bp)
app.register_blueprint(airpay_grosmart2_callback_bp)
app.register_blueprint(airpay_coco_callback_bp)
...
app.register_blueprint(paytouch4_callback_bp)
app.register_blueprint(paytouch5_coco_callback_bp)
app.register_blueprint(paytouch6_veltrix_callback_bp)
app.register_blueprint(paystorepe_veltrix_callback_bp)
app.register_blueprint(paystorepe_coco_callback_bp)
app.register_blueprint(bridgmoney_coco_callback_bp)
app.register_blueprint(bridgmoney_coco_beneficiary_bp)
...
app.register_blueprint(oxymoney_truaxis_bp)
app.register_blueprint(oxymoney_truaxis_callback_bp)
app.register_blueprint(oxymoney_barringer_bp)
app.register_blueprint(oxymoney_barringer_callback_bp)
...
app.register_blueprint(rmscoco_callback_bp)
app.register_blueprint(hdfcpaytouch_barringer_callback_bp)
app.register_blueprint(upilnk_coco_callback_bp)
app.register_blueprint(toucanpay_veltrix_callback_bp)
app.register_blueprint(payplus_veltrix_callback_bp)
...
app.register_blueprint(bulk_bank_bp)
...
def log_request_info():
    ...
    ip = get_real_ip()
    print(f"INFO:app:â†’ {request.method} {request.path} | IP: {ip} | User-Agent: {request.headers.get('User-Agent', 'N/A')}")
    if request.method in ['POST', 'PUT', 'PATCH'] and request.is_json:
        ...
        if body:
            ...
            print(f"INFO:app:â†’ Request Body: {safe_body}")

@app.after_request
def log_response_info(response):
    """Log outgoing response details"""
    ip = get_real_ip()
    print(f"INFO:app:â† {request.method} {request.path} | Status: {response.status_code} | IP: {ip}")
    return response
            ...
            with conn.cursor() as cursor:
                ...
                return jsonify({
                    ...
                    'credentials': {
                        ...
                        'base_url': 'https://api.rupipay.shop'
                    },
