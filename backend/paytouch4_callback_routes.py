"""
PayTouch4_Barringer Callback Routes
Handles webhook callbacks from PayTouch4_Barringer for payout status updates
"""
...
paytouch4_callback_bp = Blueprint('paytouch4_callback', __name__, url_prefix='/api/callback')

@paytouch4_callback_bp.route('/paytouch4/payout', methods=['POST'])
def paytouch4_payout_callback():
    """
    Webhook endpoint for PayTouch4_Barringer payout callbacks
    ...
    try:
        ...
        print("=" * 80)
        print("PayTouch4_Barringer Payout Callback Received")
        print("=" * 80)
        ...
        utr = (
            callback_data.get('utr_no') or  # PayTouch4 uses utr_no
            ...
            with conn.cursor() as cursor:
                ...
                if transaction_id:
                    cursor.execute("""
                        ...
                        WHERE pg_txn_id = %s AND pg_partner = 'Paytouch4_Barringer'
                    """, (transaction_id,))
                else:
                    ...
                    if txn['merchant_id']:
                        ...
                        if callback_url:
                            ...
                            merchant_callback_data = {
                                ...
                                'pg_partner': 'Paytouch4_Barringer',
                                'amount': amount,
